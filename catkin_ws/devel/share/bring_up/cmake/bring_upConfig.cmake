...
if("TRUE" STREQUAL "TRUE")
  set(bring_up_SOURCE_PREFIX /home/davidtrejo/Rayo_McQueen/catkin_ws/src/bring_up)
  set(bring_up_DEVEL_PREFIX /home/davidtrejo/Rayo_McQueen/catkin_ws/devel)
  set(bring_up_INSTALL_PREFIX "")
  set(bring_up_PREFIX ${bring_up_DEVEL_PREFIX})
else()
  set(bring_up_SOURCE_PREFIX "")
  set(bring_up_DEVEL_PREFIX "")
  set(bring_up_INSTALL_PREFIX /home/davidtrejo/Rayo_McQueen/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'davidtrejo <davidtrejo@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bring_up' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/davidtrejo/Rayo_McQueen/catkin_ws/src/bring_up/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT bring_up_NUM_DUMMY_TARGETS)
      set(bring_up_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::bring_up::wrapped-linker-option${bring_up_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR bring_up_NUM_DUMMY_TARGETS "${bring_up_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::bring_up::wrapped-linker-option${bring_up_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND bring_up_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/davidtrejo/Rayo_McQueen/catkin_ws/devel/lib;/home/davidtrejo/Rayo_McQueen/catkin_ws/devel/lib;/home/davidtrejo/Webots-ROS/catkin_ws/devel/lib;/opt/ros/melodic/lib)
